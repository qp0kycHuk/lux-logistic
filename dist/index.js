...
var animOnScroll = function animOnScroll() {
  var scrollItems = document.querySelectorAll('.-el-hid-');
  ...
  for (var i = 0; i < scrollItems.length; i++) {
    ...
    var itemStart = 4;
    var itemPoint = window.innerHeight - itemHeight / itemStart;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setPlaceholders": () => (/* binding */ setPlaceholders)
/* harmony export */ });
...
function setPlaceholders() {
  var inputs = _toConsumableArray(document.querySelectorAll('[data-mobile-placeholder]'));

  var isMobile = document.body.clientWidth < _constants__WEBPACK_IMPORTED_MODULE_0__.MEDIA.md;
  inputs.forEach(function (input) {
    var mobilePlaceholder = input.getAttribute('data-mobile-placeholder');
    var desctopPlaceholder = input.getAttribute('data-desctop-placeholder') || input.getAttribute('placeholder');
...
function loadHandler() {
  ...
  ymaps__WEBPACK_IMPORTED_MODULE_8__["default"].load().then(function (maps) {
    var inputs = _toConsumableArray(document.querySelectorAll('[data-suggest-view]'));
...
function clickHandler(event) {
  function scrollTo() {
    ...
    var href = target.getAttribute('data-scroll');
    if (!href) return;
